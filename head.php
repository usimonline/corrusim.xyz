...
$adres_url_yandex = "https://api-maps.yandex.ru/frame/v1/-/CZg8nK~2";
$price_copy_1 = 95;
...
<link rel="stylesheet" href="./index_files/foundation-responsive.css">
...
<script type="text/javascript" async="" src="./index_files/global_est.js.Без названия"></script>
...
<script src="./index_files/wp-emoji-release.min.js.Без названия" type="text/javascript"></script>
<style type="text/css">
    img.wp-smiley,
    img.emoji {
...
<link rel="stylesheet" id="style-custom-css" href="./index_files/style-custom.css" type="text/css" media="all">
<link rel="stylesheet" id="Google-Font-Droid+Serif-css" href="./index_files/css" type="text/css" media="all">
<link rel="stylesheet" id="Google-Font-Open+Sans-css" href="./index_files/css(1)" type="text/css" media="all">
<link rel="stylesheet" id="Google-Font-Open+Sans+Condensed-css" href="./index_files/css(2)" type="text/css" media="all">
<link rel="stylesheet" id="contact-form-7-css" href="./index_files/styles.css" type="text/css" media="all">
<link rel="stylesheet" id="wp-lightbox-2.min.css-css" href="./index_files/lightbox.min.ru_RU.css" type="text/css" media="all">
...
<script type="text/javascript" src="./index_files/jquery.js.Без названия"></script>
<script type="text/javascript" src="./index_files/jquery-migrate.min.js.Без названия"></script>
<script type="text/javascript" src="./index_files/jquery.fitvids.js.Без названия"></script>
...
<style type="text/css">
    ...
    .nivo-controlNav a, ls-bottom-slidebuttons a{
        z-index: 1000;
        position: relative;
        behavior: url( <?php echo $site_url?> wp-content/themes/bluediamond/stylesheet/ie-fix/PIE.php);
    }
...
<script type="text/javascript" src="./index_files/button.js.Без названия"></script><style type="text/css">.fancybox-margin{margin-right:17px;}</style><style type="text/css">.ya-share2,
    .ya-share2 * {
        line-height: normal;
    }
    ...
    .ya-share2__container_size_s .ya-share2__item_service_collections .ya-share2__icon
    {
        ...
        background: url(data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjQgMjQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PHBhdGggZD0iTTcgMThsNS0yLjcxTDE3IDE4VjZIN3YxMnoiIGZpbGw9IiNGRkYiIGZpbGwtcnVsZT0iZXZlbm9kZCIvPjwvc3ZnPg==), linear-gradient(transparent, transparent);
    }
    ...
    .ya-share2__container_size_s .ya-share2__item_service_delicious .ya-share2__icon
    {
        ...
        background: url(data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjQgMjQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PHBhdGggZD0iTTQgMTJoOHY4SDR6bTgtOGg4djhoLTcuOTg0eiIgZmlsbD0iI0ZGRiIgZmlsbC1ydWxlPSJldmVub2RkIi8+PC9zdmc+Cg==), linear-gradient(transparent, transparent);
    }
...
<script type="text/javascript" src="./index_files/all-settings-default.js.Без названия" charset="utf-8"></script>
