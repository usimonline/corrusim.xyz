...
<li>
<p>Как составить ТЗ на наполнение сайта?</p>
<div>
ТЗ на наполнение сайта может включать в себя:<p></p>
<ul>
<li>список страниц сайта, которые нужно заполнить контентом;</li>
<li>желаемый объем текста для каждой страницы;</li>
<li>ключевые слова (если они определены);</li>
<li>любые требования и пожелания.</li>
</ul>
<p>Помимо этого вы можете заполнить бриф, ответив всего на несколько вопросов.
</p>
</div>
</li>
<li>
...
<div class="shortcode1-3 ">
<img class="wp-image-7887 aligncenter" src="./napolnenie-sajta_files/mail-1.png" alt="mail" width="55" height="55">
</div>
<div class="shortcode1-3 last">
<img class="wp-image-7773 aligncenter" src="./napolnenie-sajta_files/обсуждение-деталей.png" alt="обсуждение деталей" width="55" height="55">
</div>
<div class="clear"></div>
<div class="shortcode1-3 ">
<p style="text-align: center;"><span style="font-size: 10pt;">1. Составьте техническое задание (ТЗ) на наполнение сайта.</span></p>
</div>
<div class="shortcode1-3 ">
<p style="text-align: center;"><span style="font-size: 10pt;">2. Пришлите ТЗ нам&nbsp;по адресу <?php echo $site_email_1;?>.</span></p>
</div>
<div class="shortcode1-3 last">
<p style="text-align: center;"><span style="font-size: 10pt;">3. Заполните онлайн-бриф, ответив всего на несколько вопросов.</span></p>
</div>
<div class="clear"></div>
<div class="shortcode1-3 ">
<img class="wp-image-8075 aligncenter" src="./napolnenie-sajta_files/check.png" alt="check" width="55" height="55">
</div>
<div class="shortcode1-3 ">
<img class="wp-image-7844 aligncenter" src="./napolnenie-sajta_files/calendar.png" alt="calendar" width="55" height="55">
</div>
<div class="shortcode1-3 last">
<img class="wp-image-7845 aligncenter" src="./napolnenie-sajta_files/creditcard.png" alt="creditcard" width="55" height="55">
</div>
<div class="clear"></div>
<div class="shortcode1-3 ">
...
<div class="shortcode1-3 ">
<img class="wp-image-8012 aligncenter" src="./napolnenie-sajta_files/genius.png" alt="genius" width="55" height="55">
</div>
<div class="shortcode1-3 last">
<img class="wp-image-7771 aligncenter" src="./napolnenie-sajta_files/flame.png" alt="flame" width="55" height="55">
</div>
<div class="clear"></div>
<div class="shortcode1-3 ">
<p style="text-align: center;"><span style="font-size: 10pt;">особые требования</span></p>
</div>
<div class="shortcode1-3 ">
...
<div class="clear"></div>
<h4><img class="" src="./napolnenie-sajta_files/check-for-h.png" alt="check-for-h" width="18" height="18">&nbsp;Наполнение сайта: дополнительные услуги</h4>
