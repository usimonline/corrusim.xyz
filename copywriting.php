...
<p>Выбирать вид копирайтинга следует исходя из&nbsp;цели страницы, на которой будет размещен текст.
</p>
</div>
</li>
<li class="">
<p class="toggle-box-title">Как составить ТЗ на копирайтинг?</p>
<div class="toggle-box-content" style="display: none;">
Как правило, техническое задание на копирайтинг&nbsp;включает в себя:<p></p>
<ul>
<li>список страниц сайта, на которые&nbsp;нужны тексты;</li>
<li>желаемый объем текста для каждой страницы;</li>
<li>ключевые фразы (если они определены);</li>
<li>любые требования и пожелания.</li>
</ul>
<p>Дополнительно к этому вы можете заполнить бриф, информация из которого поможет сделать тексты более результативными.
</p>
</div>
</li>
<li class="">
<p class="toggle-box-title">Обязательно ли заполнять бриф?</p>
<div class="toggle-box-content" style="display: none;">
...
<div class="shortcode1-3 ">
<img class="wp-image-7847 aligncenter" src="./copywriting_files/email.png" alt="email" width="55" height="55">
</div>
<div class="shortcode1-3 last">
<img class="wp-image-7846 aligncenter" src="./copywriting_files/document.png" alt="document" width="55" height="55">
</div>
<div class="clear"></div>
<div class="shortcode1-3 ">
...
<div class="clear"></div>
<div class="shortcode1-3 ">
<img class="wp-image-7773 aligncenter" src="./copywriting_files/обсуждение-деталей.png" alt="обсуждение деталей" width="55" height="55">
</div>
<div class="shortcode1-3 ">
<img class="wp-image-7844 aligncenter" src="./copywriting_files/calendar.png" alt="calendar" width="55" height="55">
</div>
<div class="shortcode1-3 last">
<img class="wp-image-7845 aligncenter" src="./copywriting_files/creditcard.png" alt="creditcard" width="55" height="55">
</div>
<div class="clear"></div>
<div class="shortcode1-3 ">
...
<div class="shortcode1-3 ">
<img class=" wp-image-10129 aligncenter" src="./copywriting_files/group.png" alt="group" width="55" height="55">
</div>
<div class="shortcode1-3 last">
<img class=" wp-image-10130 aligncenter" src="./copywriting_files/keywords.png" alt="keywords" width="55" height="55">
</div>
<div class="clear"></div>
<div class="shortcode1-3 ">
<p style="text-align: center;"><span style="font-size: 10pt;">изучение&nbsp;особенностей&nbsp;вашего бизнеса и рынка</span></p>
</div>
<div class="shortcode1-3 ">
<p style="text-align: center;"><span style="font-size: 10pt;">ознакомление с потребностями вашей целевой аудитории</span></p>
</div>
<div class="shortcode1-3 last">
<p style="text-align: center;"><span style="font-size: 10pt;">оптимизация текста под нужные ключевые слова</span></p>
</div>
<div class="clear"></div>
<h4><img class="" src="./copywriting_files/check-for-h.png" alt="check-for-h" width="18" height="18">&nbsp;Копирайтинг: дополнительные услуги</h4>
